function main() {
    ...
    function agregarEventosArrastre() {
        ...
        canciones.forEach(cancion => {
            ...
            cancion.addEventListener('drag', () => console.log('dragging...'));
        });

        const artistas = document.getElementById('artistas');
        artistas.addEventListener('dragover', dragOver);
        artistas.addEventListener('drop', drop);
    }
    ...
    setTimeout(function () {
        ...
        // Crear una lista de artistas mostrados en el primer paso
        const artistasExcluidosSegundoPaso = artistasMostradosPrimerPaso.map(artista => artista.nombre);

        // Mostrar nuevos artistas y sus respectivas canciones excluyendo los del primer paso
        mostrarArtistasAleatoriosExcluyendo(artistasDatos, 3, artistasExcluidosSegundoPaso);
